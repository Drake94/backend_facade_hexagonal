package com.bf.facade.adapter.jdbc.dao.sql;
...
public class GenericDAO {
    ...
    public Integer queryForObject(String existsClientByRut, MapSqlParameterSource parameter, Class<Integer> returnType) {
        try{
            return template.queryForObject(existsClientByRut, parameter, returnType);
