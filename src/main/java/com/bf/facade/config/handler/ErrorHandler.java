package com.bf.facade.config.handler;

import com.bf.facade.adapter.rest.exception.*;
...
public class ErrorHandler {
    ...
    @ExceptionHandler({BadRequestRestCardException.class})
    public ResponseEntity<ErrorResponse> handle(BadRequestRestCardException e) {
        log.error(HttpStatus.BAD_REQUEST.getReasonPhrase(), e);
        return buildError(HttpStatus.BAD_REQUEST,e,e.getCode());
    }

    @ExceptionHandler({BadRequestRestAccountException.class})
    public ResponseEntity<ErrorResponse> handle(BadRequestRestAccountException e) {
        log.error(HttpStatus.BAD_REQUEST.getReasonPhrase(), e);
        return buildError(HttpStatus.BAD_REQUEST,e,e.getCode());
    }
